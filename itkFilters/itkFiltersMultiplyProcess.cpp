...
itkFiltersMultiplyProcess::itkFiltersMultiplyProcess( void ) : dtkAbstractProcess(), d(new itkFiltersMultiplyProcessPrivate)
{
    d->filter = this;
    d->output = NULL;
}
...
void itkFiltersMultiplyProcess::emitProgress(int progress)
{

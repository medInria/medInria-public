...
// Created:     22/06/2004
// RCS-ID:      $Id: foldpanelbar.h 609 2008-01-14 09:21:24Z filus $
...
class WX_ADDON_EXPORT wxFoldPanel
{
private:
...
public:
    ...
    */
    ...
    // to get rid of warning that there is no virtual destructor
    virtual ~wxFoldPanel() {
    };
...
WX_DEFINE_ARRAY_WITH_DECL_PTR(wxFoldPanelItem *, wxFoldPanelItemArray, class WX_ADDON_EXPORT);
...
class WX_ADDON_EXPORT wxFoldPanelBar: public wxPanel
{
private:

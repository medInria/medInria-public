...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxBitmap, wxFlatNotebookImageList, WX_ADDON_EXPORT);
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxWindow*, wxWindowPtrArray, WX_ADDON_EXPORT);
...
class WX_ADDON_EXPORT wxFlatNotebookBase : public wxPanel
{
private:
...
*/
class WX_ADDON_EXPORT wxPageInfo
{
private:
	// Members
	/// Page caption
...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxPageInfo, wxPageInfoArray, WX_ADDON_EXPORT);
...
* \brief Notebook page
*/
class WX_ADDON_EXPORT wxPageContainerBase : public wxPanel
{
protected:
...
*/
class WX_ADDON_EXPORT wxFlatNotebookEvent : public wxNotifyEvent
{
...
class WX_ADDON_EXPORT wxFlatNotebook : public wxFlatNotebookBase
{
public:
	/**
	 *
...
BEGIN_DECLARE_EVENT_TYPES()
    DECLARE_EXPORTED_EVENT_TYPE(WX_ADDON_EXPORT, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CHANGED, 50000)
    DECLARE_EXPORTED_EVENT_TYPE(WX_ADDON_EXPORT, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CHANGING, 50001)
    DECLARE_EXPORTED_EVENT_TYPE(WX_ADDON_EXPORT, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CLOSING, 50002)
    DECLARE_EXPORTED_EVENT_TYPE(WX_ADDON_EXPORT, wxEVT_COMMAND_FLATNOTEBOOK_CONTEXT_MENU, 50003)
	DECLARE_EXPORTED_EVENT_TYPE(WX_ADDON_EXPORT, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CLOSED, 50004)

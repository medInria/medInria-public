...
%1::%1(medAbstractView* parent) : medAbstractInteractor(parent), d(new %1Private)
{
...
bool %1::registered()
{
    ...
    return factory->registerAdditionalInteractor<%1>("%1", QStringList () << "TODO: view identifier"
                                           << %1::dataHandled());
}

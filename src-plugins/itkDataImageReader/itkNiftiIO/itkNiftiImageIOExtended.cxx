...
NiftiImageIOExtended::NiftiImageIOExtended():
  m_NiftiImage(0),
  m_RescaleSlope(1.0),
...
bool
NiftiImageIOExtended::MustRescale()
{
...
void NiftiImageIOExtended::Read(void *buffer)
{
  void *data = 0;
...
// metadata dictionary.
void NiftiImageIOExtended::SetImageIOMetadataFromNIfTI()
{
  int             swap = 0;
...
void
NiftiImageIOExtended::SetImageIOOrientationFromNIfTI(unsigned short int dims)
{
...
void
NiftiImageIOExtended::SetNIfTIOrientationFromImageIO(unsigned short int origdims, unsigned short int dims)
{
  //
  // use NIFTI method 2

 ...
 * \ingroup IOFilters
 */
class ITKIO_EXPORT NiftiImageIOExtended:public ImageIOBase
{
public:
  /** Standard class typedefs. */
  typedef NiftiImageIOExtended Self;
  ...
  itkTypeMacro(NiftiImageIOExtended, Superclass);
...
private:
  ...
  NiftiImageIOExtended(const Self &);   //purposely not implemented

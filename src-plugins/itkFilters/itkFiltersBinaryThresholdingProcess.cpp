...
itkFiltersBinaryThresholdingProcess::~itkFiltersBinaryThresholdingProcess( void )
{
    delete d;
}
...
bool itkFiltersBinaryThresholdingProcess::registered( void )
{
...
{
    return tr("ITK binary thresholding filter");
}

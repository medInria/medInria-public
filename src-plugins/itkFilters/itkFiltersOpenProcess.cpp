...
{
public:
    itkFiltersOpenProcessPrivate(itkFiltersOpenProcess *q) {parent = q;}
    virtual ~itkFiltersOpenProcessPrivate(void) {}

    itkFiltersOpenProcess *parent;
...
itkFiltersOpenProcess::itkFiltersOpenProcess(itkFiltersOpenProcess *parent) 
    : itkFiltersProcessBase(parent), d(new itkFiltersOpenProcessPrivate(this))
{    
    this->setFilter(this);
...
QList<medAbstractParameter*> itkFiltersOpenProcess::parameters()
{
    return d->parameters;
}

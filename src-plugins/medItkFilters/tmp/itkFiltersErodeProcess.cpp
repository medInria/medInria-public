...
public:
    ...
    template <class PixelType> void update ( void )
    {
        ...
        erodeFilter->SetInput ( dynamic_cast<ImageType *> ( ( itk::Object* ) ( parent->input<medAbstractData*>(0)->data() ) ) );
        ...
        erodeFilter->Update();
        parent->output<medAbstractData*>(0)->setData ( erodeFilter->GetOutput() );

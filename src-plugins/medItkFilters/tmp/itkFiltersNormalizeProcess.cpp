...
public:
    ...
    template <class PixelType> void update ( void )
    {
        ...
        normalizeFilter->SetInput ( dynamic_cast<ImageType *> ( ( itk::Object* ) ( parent->input<medAbstractData*>(0)->data() ) ) );
        ...
        parent->output<medAbstractData*>(0)->setData ( normalizeFilter->GetOutput() );

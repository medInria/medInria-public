...
class MEDITKSHIMAGEPLUGIN_EXPORT medItkSHImageDataReaderBase : public dtkAbstractDataReader
{
    Q_OBJECT

public:
             medItkSHImageDataReaderBase();
    virtual ~medItkSHImageDataReaderBase();
...
public slots:
    ...
    /** it reads the information of vector medItkFloat3SHImageData or itkDataSHImageDoublet3*/

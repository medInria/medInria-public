...
class MEDVTKMESHPLUGIN_EXPORT medVtkViewVtkMeshInteractor: public medAbstractImageViewInteractor
{
    Q_OBJECT

public:
    medVtkViewVtkMeshInteractor(medAbstractView* parent);
    virtual ~medVtkViewVtkMeshInteractor();
...
private:
    medVtkViewVtkMeshInteractorPrivate * d;
};

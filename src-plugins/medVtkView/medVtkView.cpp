...
medAbstractImageViewInteractor* medVtkView::primaryInteractor(unsigned int layer)
{
...
medAbstractImageViewNavigator* medVtkView::primaryNavigator()
{
    d->primaryNavigator;
}
...
void medVtkView::removeInteractors(medAbstractData *data)
{

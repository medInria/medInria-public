...
//    virtual QPointF mapWorldToDisplayCoordinates( const QVector3D & worldVec ) const;
//    //! Convert from scene coordinates to world coordinates.
//    virtual QVector3D mapDisplayToWorldCoordinates( const QPointF & scenePoint ) const;

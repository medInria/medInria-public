...
medItkClosingImageProcess::medItkClosingImageProcess(QObject *parent): medAbstractClosingImageProcess(parent),
    d(new medItkClosingImageProcessPrivate)
{
    d->details = medProcessLayer::readDetailsFromJson(":/medItkClosingImageProcessPlugin.json");
}
...
medProcessDetails medItkClosingImageProcess::details() const
{
    return d->details;
}

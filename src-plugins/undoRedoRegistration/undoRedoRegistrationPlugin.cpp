...
{
    if(!undoRedoRegistration::registered())
        dtkWarn() << "Unable to register undoRedoRegistration type";
    
    if(!undoRedoRegistrationToolBox::registered())
        dtkWarn() << "Unable to register undoRedoRegistration toolbox";

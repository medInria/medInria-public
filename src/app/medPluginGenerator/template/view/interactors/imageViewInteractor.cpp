...
%1::%1(medAbstractView* parent) : medAbstractImageViewInteractor(parent), d(new %1Private)
{
...
void %1::setOpacity(double opacity)
{
    // TODO: set data opacity in the view
}

void %1::setWindowLevel(QHash<QString,QVariant>)
{
    // TODO: set data WL in the view
}

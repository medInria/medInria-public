...
medDatabaseView::medDatabaseView(QWidget *parent) : QTreeView(parent), d(new medDatabaseViewPrivate)
{
    ...
    d->viewAction->setIcon(QIcon::fromTheme("eye"));
    ...
    d->exportAction->setIcon(QIcon::fromTheme("export"));
    ...
    d->saveAction->setIcon(QIcon::fromTheme("save"));
    ...
    d->addPatientAction->setIcon(QIcon::fromTheme("user_add"));
    ...
    d->addStudyAction->setIcon(QIcon::fromTheme("study_add"));
    ...
    d->editAction->setIcon(QIcon::fromTheme("edit"));
    ...
    d->metadataAction->setIcon(QIcon::fromTheme("metadata"));

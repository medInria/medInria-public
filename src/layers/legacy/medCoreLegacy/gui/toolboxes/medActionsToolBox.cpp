...
medActionsToolBox::medActionsToolBox( QWidget *parent /*= 0*/, bool FILE_SYSTEM ) : medToolBox(parent), d(new medActionsToolBoxPrivate)
{
    ...
    d->viewBt->setIcon(QIcon(":icons/eye_white.png"));
    ...
    if (FILE_SYSTEM)
    {
        ...
        d->loadBt->setIcon(QIcon(":/icons/import_temporary_white.png"));
        ...
        d->importBt->setIcon(QIcon(":/icons/import_white.png"));
    ...
    else //IF DATABASE
    {
        ...
        d->saveBt->setIcon(QIcon(":/icons/save_white.png"));
        ...
        d->newPatientBt->setIcon(QIcon(":/icons/user_add_white.png"));
        ...
        d->newStudyBt->setIcon(QIcon(":/icons/study_add_white.png"));
        ...
        d->editBt->setIcon(QIcon(":/icons/edit_white.png"));
        ...
        d->exportBt->setIcon(QIcon(":/icons/export_white.png"));

...
medActionsToolBox::medActionsToolBox( QWidget *parent /*= 0*/, bool FILE_SYSTEM ) : medToolBox(parent), d(new medActionsToolBoxPrivate)
{
    ...
    d->viewBt->setIcon(QIcon::fromTheme("eye"));
    ...
    if (FILE_SYSTEM)
    {
        ...
        d->loadBt->setIcon(QIcon::fromTheme("import_temporary"));
        ...
        d->importBt->setIcon(QIcon::fromTheme("import_permanent"));
    ...
    else //IF DATABASE
    {
        ...
        d->saveBt->setIcon(QIcon::fromTheme("save"));
        ...
        d->newPatientBt->setIcon(QIcon::fromTheme("user_add"));
        ...
        d->newStudyBt->setIcon(QIcon::fromTheme("study_add"));
        ...
        d->editBt->setIcon(QIcon::fromTheme("edit"));
        ...
        d->exportBt->setIcon(QIcon::fromTheme("export"));

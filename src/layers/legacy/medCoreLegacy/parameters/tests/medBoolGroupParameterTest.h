...
class medBoolGroupParameterTestObject : public QObject
{
    Q_OBJECT

public:
             medBoolGroupParameterTestObject();
    virtual ~medBoolGroupParameterTestObject();


private:
     QString m_name;
     QWidget* m_widget;
     QWidget* m_pushButtonGroup;
     QWidget* m_radioButtonGroup;
     QWidget* m_checkBoxGroup;

...
#ifndef ITKPROCESSREGISTRATIONBALOO_H
#define ITKPROCESSREGISTRATIONBALOO_H
...
class ITKPROCESSREGISTRATIONBALOOPLUGIN_EXPORT itkProcessRegistrationBaloo : public itkProcessRegistration
{
    Q_OBJECT

public:
             itkProcessRegistrationBaloo(void);
    virtual ~itkProcessRegistrationBaloo(void);
...
public:
    ...
    void setTransformationType(const QString& type);
...
private:
    itkProcessRegistrationBalooPrivate *d;
    friend class itkProcessRegistrationBalooPrivate;
};

...
class MEDITKMORPHOMATHOPERATIONPROCESSPLUGIN_EXPORT medItkDilateImageProcess: public medAbstractDilateImageProcess
{
    Q_OBJECT
public:
    ...
    medItkDilateImageProcess(QObject* parent = nullptr);

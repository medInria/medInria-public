...
class MEDITKMORPHOMATHOPERATIONPROCESSPLUGIN_EXPORT medItkErodeImageProcess: public medAbstractErodeImageProcess
{
    Q_OBJECT
public:
    ...
    medItkErodeImageProcess(QObject* parent = nullptr);

...
class MEDITKSINGLEFILTEROPERATIONPLUGIN_EXPORTS medItkDivideProcess: public medAbstractDivideFilterProcess
{
    Q_OBJECT
public:
    ...
    medItkDivideProcess(QObject* parent = nullptr);
    ~medItkDivideProcess();
...
inline medAbstractDivideFilterProcess* medItkDivideProcessCreator()
{

...
class MEDITKSINGLEFILTEROPERATIONPROCESSPLUGINS_EXPORTS medItkMultiplyProcess: public medAbstractMultiplyFilterProcess
{
    Q_OBJECT
public:
    static void eventCallback(itk::Object *caller, const itk::EventObject& event, void *clientData)
    {
        medItkMultiplyProcess * source = reinterpret_cast<medItkMultiplyProcess *>(clientData);
...
inline medAbstractSingleFilterOperationProcess* medItkMultiplyProcessCreator()
{
    return new medItkMultiplyProcess();
}

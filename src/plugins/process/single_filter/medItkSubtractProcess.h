...
class MEDITKSINGLEFILTEROPERATIONPROCESSPLUGINS_EXPORTS medItkSubtractProcess: public medAbstractSubtractFilterProcess
{
    Q_OBJECT
public:
...
inline medAbstractSingleFilterOperationProcess* medItkSubtractProcessCreator()
{

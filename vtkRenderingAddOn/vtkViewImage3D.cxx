...
#if ( VTK_MAJOR_VERSION==5 && VTK_MINOR_VERSION>=6 && VTK_BUILD_VERSION>=1) || VTK_MAJOR_VERSION>5
				       , this->GetRenderer()
#endif
	  ) )
    {
      ...
      if( !mapper3D->IsRenderSupported ( this->VolumeProperty
#if ( VTK_MAJOR_VERSION==5 && VTK_MINOR_VERSION>=7 && VTK_BUILD_VERSION>=1) || VTK_MAJOR_VERSION>5
					 , this->GetRenderer()
#endif
	    ) )
      {

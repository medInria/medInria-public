...
// Created:     18/06/2004
// RCS-ID:      $Id: captionbar.cpp,v 1.1 2006/08/03 15:42:43 pfillard Exp $
...
BEGIN_EVENT_TABLE(wxCaptionBar, wxWindow)
	...
	EVT_ERASE_BACKGROUND(wxCaptionBar::OnEraseBackground)
END_EVENT_TABLE()
...
void wxCaptionBar::OnMouseEvent(wxMouseEvent& event)
{
    ...
    if(send_event)
    {
        wxCaptionBarEvent c_event(wxEVT_CAPTIONBAR);
        c_event.SetCaptionBar(this);

        ::wxPostEvent(this, c_event);
...
void wxCaptionBar::OnEraseBackground(wxEraseEvent&)
{

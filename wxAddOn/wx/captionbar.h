...
// Created:     22/06/2004
// RCS-ID:      $Id: captionbar.h 609 2008-01-14 09:21:24Z filus $
...
*/
class WX_ADDON_EXPORT wxCaptionBarStyle
{
private:
...
public:
    ...
    /** Returns the font for the caption bar. Please be warned this will result in an assertion failure when
        ...
        SetCaptionFont(), CaptionFontUsed() */
    ...
    /** Returns the first colour for the caption bar. Please be warned this will
        ...
        SetCaptionFirstColour(), CaptionFirstColourUsed() */
    ...
    /** Returns the second colour for the caption bar. Please be warned this will result in
        ...
        SetSecondColour(), SecondColourUsed() */
    ...
    /** Returns the caption colour for the caption bar. Please be warned this will
        result in an assertion failure when this property is not previously set.
        SetCaptionColour(), CaptionColourUsed() */
    ...
    */
    ...
    /** Returns the caption style for the caption bar. Please be warned this will
        result in an assertion failure when this property is not previously set.
        SetCaptionStyle(), CaptionStyleUsed() */
...
class WX_ADDON_EXPORT wxCaptionBar: public wxWindow
{
private:
    wxString m_caption;
...
class WX_ADDON_EXPORT wxCaptionBarEvent : public wxCommandEvent
{
...
BEGIN_DECLARE_EVENT_TYPES()
    DECLARE_EXPORTED_EVENT_TYPE(WX_ADDON_EXPORT, wxEVT_CAPTIONBAR, 0)

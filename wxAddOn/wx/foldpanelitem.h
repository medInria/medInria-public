...
// Created:     22/06/2004
// RCS-ID:      $Id: foldpanelitem.h 609 2008-01-14 09:21:24Z filus $
...
class WX_ADDON_EXPORT wxFoldWindowItem
{
private:
    wxWindow *m_wndItem;
    int m_type, m_flags;
...
WX_DECLARE_OBJARRAY_WITH_DECL(wxFoldWindowItem, wxFoldWindowItemArray, class WX_ADDON_EXPORT);
...
class WX_ADDON_EXPORT wxFoldPanelItem: public wxPanel
{
private:

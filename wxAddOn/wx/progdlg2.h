////////////////////////////////////////////////////
// Name:        progdlgg.h
// Purpose:     wxProgressDialog2 class
// Author:      Karsten Ballüder
// Modified by:
// Created:     09.05.1999
// RCS-ID:      $Id: progdlg2.h 1168 2009-06-10 08:36:34Z filus $
// Copyright:   (c) Karsten Ballüder
// Licence:     wxWindows licence
////////////////////////////////////////////////////

#ifndef __PROGDLG2H_G__
#define __PROGDLG2H_G__
...
class WXDLLIMPEXP_FWD_BASE wxButton;
class WXDLLIMPEXP_FWD_BASE wxGauge;
...
class WX_ADDON_EXPORT wxProgressDialog2 : public wxDialog
{
DECLARE_DYNAMIC_CLASS(wxProgressDialog2)
public:
   ...
   */
   wxProgressDialog2(const wxString &title, wxString const &message,
                    int maximum = 100,
...
#if wxCHECK_VERSION(2,8,7)
    class WXDLLIMPEXP_FWD_BASE wxWindowDisabler *m_winDisabler;
#else
    class WXDLLEXPORT wxWindowDisabler *m_winDisabler;
#endif

    DECLARE_EVENT_TABLE()
    DECLARE_NO_COPY_CLASS(wxProgressDialog2)
};

#endif // wxUSE_PROGRESSDLG

#endif // __PROGDLG2H_G__

...
Program:   vtkINRIA3D
Module:    $Id: wxFNBDropTarget.h 609 2008-01-14 09:21:24Z filus $
Language:  C++
Author:    $Author: filus $
Date:      $Date: 2008-01-14 10:21:24 +0100 (lun, 14 jan 2008) $
...
*/
class WX_ADDON_EXPORT wxFNBDragInfo
{
...
class WX_ADDON_EXPORT wxFNBDragInfoDataObject : public wxDataObjectSimple
{
public:
...
*/
template <class T>
class WX_ADDON_EXPORT wxFNBDropTarget : public wxDropTarget
{
private:
